...
public class PersonController extends ControllerWithSearchBase<Person, PersonDto, PersonDomain,
	...
	public ResponseEntity<JwtResponse> createPerson(@Valid @ModelAttribute PersonDto personDto
		...
		return ResponseEntity.ok(userAuthentication.authenticate(personDto.getEmail(), personDto.getPassword()));
	}
